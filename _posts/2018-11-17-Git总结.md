...
# 前言
Linux大神Linus 1991年创建了Linux社区，2002年以前，由世界各地的人提供code给Linus,由他手动加入到Linux内核代码,2002年，bitmover公司授权免费使用bitkeeper版本控制系统，不需要再手动。但是Linux社区人才辈出，有人试图破解bitkeeper被发现，警告多次没用，
...
整个文件目录为<Strong>工作区</Strong>,隐藏的.git目录不算工作区，而是版本库，是<Strong>暂存区</Strong>(stage或index)，以及另一部分是分支(如master)
